...
module.exports = function(app) {
    // USER ROUTES
    // carousel Routes
    app.route("/carousel").get(carousel.list_all_user);
    // reviews Routes
    app.route("/reviews").get(review.list_all_user);
    // category Routes
    app.route("/category").get(category.list_all_user);
    // product Routes
    app.route("/product").get(product.list_all_products);
    app
        .route("/product/category_url=:url")
        .get(product.list_all_under_category_url);
    app.route("/product/:url").get(product.readByUrl);
    // shop Data Routes
    app.route("/shop-data").get(shopData.list_all);
    // ADMIN ROUTES
    // carousel Routes
    app.route("/admin/carousel").get(carousel.list_all).post(carousel.create);
    ...
    // reviews Routes
    app.route("/admin/reviews").get(review.list_all).post(review.create);
    ...
    // category Routes
    app.route("/admin/category").get(category.list_all).post(category.create);
    ...
    // product Routes
    app.route("/admin/products").get(product.list_all).post(product.create);
    ...
    // orders Routes
    app.route("/admin/orders").get(orders.list_all).post(orders.create);
    ...
    // customers Routes
    app.route("/admin/customers").get(customers.list_all).post(customers.create);
    ...
    // carrier Routes
    app.route("/admin/carriers").get(carriers.list_all).post(carriers.create);
    ...
    // tax Routes
    app.route("/admin/tax").get(tax.list_all).post(tax.create);
    ...
    // employees Routes
    app.route("/admin/employees").get(employees.list_all).post(employees.create);
    ...
    // shop Data Routes
    app.route("/admin/shop-data").get(shopData.list_all).post(shopData.create);
    ...
    //  Session
    app.route("/sessions").post(session.login).delete(session.logout);

    app.route("/sessions/user").get(session.user).post(session.register);
};